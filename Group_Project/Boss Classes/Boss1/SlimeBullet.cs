...
{
    public class SlimeBullet : GameObject
    {
        ...
        public SlimeBullet(PlayScene playScene, float x, float y, float angle) : base(playScene)
        {
            this.x = x;
            this.y = y;
            this.angle = angle;
        ...
        {
            Camera.DrawGraph(x, y, Image.slimeBullet);
        }

        public override void OnCollision(GameObject other)
        {
            if (other is Slime) return;
            Kill();
        }
        ...
        public override void Kill()
        {
            ...
            playScene.pm.BreakWall(x + imageWidth / 2, y + imageHeight / 2, 0, 255, 0);
