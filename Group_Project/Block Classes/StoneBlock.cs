...
{
    public class StoneBlock : GameObject
    {
        ...
        public StoneBlock(PlayScene playScene, float x, float y, float angle) : base(playScene)
        {
            this.x = x;
            this.y = y;
            this.angle = angle;
        ...
        {
            Camera.DrawGraph(x, y, Image.stoneBullet);
        }

        public override void OnCollision(GameObject other)
        {
            if (other is Player || other is StoneBlock) return;
        ...
        public override void Kill()
        {
            ...
            playScene.pm.BreakWall(x + imageWidth / 2, y + imageHeight / 2, 100, 100, 100);
        }
    }
}
