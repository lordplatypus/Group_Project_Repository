...
{
    public class DiamondBlock : GameObject
    {
        ...
        public DiamondBlock(PlayScene playScene, float x, float y, float angle) : base(playScene)
        {
            this.x = x;
            this.y = y;
            this.angle = angle;
        ...
        {
            Camera.DrawGraph(x, y, Image.diamondBullet);
        }

        public override void OnCollision(GameObject other)
        {
            if (other is Player || other is DiamondBlock || other is Boss3 || other is Boss3SmashAttack) return;
